...
class Utils {
  ...
  /**
   * Get project management options
   *
   * @return array $options The project management options
   */
  public static function get_options() {
    $options = get_option('project_management_settings_dogbytemarketing');

    return $options;
  }
  
  /**
   * Get project management option from options array
   *
  ...
  public static function update_option($option, $value) {
    ...
    update_option('project_management_settings_dogbytemarketing', $options);
  }
  ...
  public static function send_success($message, $code = 200) {
    $message = $message ? sanitize_text_field($message) : __('Success', 'project-management');
  ...
  public static function send_error($message, $code = 400) {
    $message = $message ? sanitize_text_field($message) : __('Error', 'project-management');
   ...
   */
  public static function mark_project_management_read($current_user_id) {
    $task_ids = array();
   ...
   * @return int $task_count The number of tasks a user has
   */
  public static function get_project_management_count($current_user_id) {
    $task_count     = 0;
