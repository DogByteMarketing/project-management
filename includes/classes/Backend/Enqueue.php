...
class Enqueue {
  ...
  public function enqueue($hook_suffix) {
    if ($hook_suffix === 'task_page_project-management') {
      $this->enqueue_styles();
  ...
  private function enqueue_styles() {
    wp_enqueue_style('project-management-settings', plugins_url('/css/backend/settings.css', $this->plugin), array(), $this->version);
  ...
  private function enqueue_scripts() {
    wp_enqueue_script('project-management-settings', plugins_url('/js/backend/settings.js', $this->plugin), array('jquery', 'wp-color-picker', 'wp-i18n'), $this->version, true);
    wp_set_script_translations('project-management-settings', 'project-management', plugin_dir_path($this->plugin) . '/languages/');
