...
class ClickUp {
  ...
  const API_URL = 'https://www.dogbytemarketing.com/wp-json/project-management-api/v1';
  ...
  public function create_clickup_webhook() {
    ...
    $body = array(
      ...
      'workspace_id'  => $workspace_id,
      'list_id'       => $list_id,
      'endpoint'      => home_url() . '/wp-json/project-management/v1/clickup/webhook/?token=' . $webhook_token,
    );
