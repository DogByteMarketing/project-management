...
class Widget {
  ...
  public function add_dashboard_widget() {
    wp_add_dashboard_widget(
      'project_management_tasks_widget',        // Widget slug
      __('Recent Tasks', 'project-management'), // Title
  ...
  public function render_dashboard_widget() {
    ...
    if (empty($all_tasks)) {
      echo '<p>' . esc_html__('No tasks found.', 'project-management') . '</p>';
      return;
    }
    ...
    echo '<thead><tr>
            <th>' . esc_html__('Task', 'project-management') . '</th>
            <th>' . esc_html__('Status', 'project-management') . '</th>
            <th>' . esc_html__('Priority', 'project-management') . '</th>
          </tr></thead><tbody>';
    ...
    foreach ($tasks_with_priority as $item) {
      ...
      $priority_key = get_post_meta($task->ID, '_task_priority', true);
      $status       = isset($this->statuses[$status_key]) ? $this->statuses[$status_key] : __('N/A', 'project-management');
      $priority     = isset($this->priorities[$priority_key]) ? $this->priorities[$priority_key] : __('N/A', 'project-management');
    ...
    echo '<a href="' . esc_url($create_url) . '" class="button button-primary">' . esc_html__('Create New Task', 'project-management') . '</a>';
    echo '<a href="' . esc_url($view_url) . '" class="button button-secondary">' . esc_html__('View All Tasks', 'project-management') . '</a>';
    echo '</div>';
  }
