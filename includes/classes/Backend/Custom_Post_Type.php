...
class Custom_Post_Type {
  ...
  public function create_task_post_type() {
    $args = array(
      'labels' => array(
        'name'               => __('Tasks', 'project-management'),
        'singular_name'      => __('Task', 'project-management'),
        'add_new'            => __('Add New Task', 'project-management'),
        'add_new_item'       => __('Add New Task', 'project-management'),
        'edit_item'          => __('Edit Task', 'project-management'),
        'new_item'           => __('New Task', 'project-management'),
        'view_item'          => __('View Task', 'project-management'),
        'search_items'       => __('Search Tasks', 'project-management'),
        'not_found'          => __('No tasks found', 'project-management'),
        'not_found_in_trash' => __('No tasks found in Trash', 'project-management'),
        'all_items'          => __('All Tasks', 'project-management'),
        'menu_name'          => __('Tasks', 'project-management'),
        'name_admin_bar'     => __('Task', 'project-management'),
      ),
      'public'            => false,
      'has_archive'       => true,
      'show_ui'           => true,
  ...
  public function add_meta_boxes() {
    add_meta_box(
      'task_priority',
      __('Task Priority', 'project-management'),
    ...
    add_meta_box(
      'task_status',
      __('Task Status', 'project-management'),
  ...
  public function render_priority_meta_box($post) {
    ...
    <select name="task_priority">
      <option value="4" <?php selected($value, 4); ?>><?php esc_html_e('Low', 'project-management'); ?></option>
      <option value="3" <?php selected($value, 3); ?>><?php esc_html_e('Normal', 'project-management'); ?></option>
      <option value="2" <?php selected($value, 2); ?>><?php esc_html_e('High', 'project-management'); ?></option>
      <option value="1" <?php selected($value, 1); ?>><?php esc_html_e('Urgent', 'project-management'); ?></option>
    </select>
    <?php
  }
  ...
  public function add_task_columns($columns) {
    $columns['task_status']   = __('Status', 'project-management');
    $columns['task_priority'] = __('Priority', 'project-management');
    return $columns;
  }
        ...
        <div class="inline-edit-col">
          <?php if ($column_name === 'task_priority') : ?>
            <label class="alignleft">
              <span class="title"><?php esc_html_e('Priority', 'project-management'); ?></span>
              <select name="task_priority">
                <option value="4"><?php esc_html_e('Low', 'project-management'); ?></option>
                <option value="3"><?php esc_html_e('Normal', 'project-management'); ?></option>
                <option value="2"><?php esc_html_e('High', 'project-management'); ?></option>
                <option value="1"><?php esc_html_e('Urgent', 'project-management'); ?></option>
              </select>
            </label>
          <?php elseif ($column_name === 'task_status') : ?>
            <label class="alignleft">
              <span class="title"><?php esc_html_e('Status', 'project-management'); ?></span>
              <select name="task_status">
                <option value="pending"><?php esc_html_e('Pending', 'project-management'); ?></option>
                <option value="in_progress"><?php esc_html_e('In Progress', 'project-management'); ?></option>
                <option value="complete"><?php esc_html_e('Complete', 'project-management'); ?></option>
              </select>
            </label>
          <?php endif; ?>
        </div>
  ...
  public function add_priority_filter_dropdown() {
    ...
    echo '<option value="">' . esc_html__('All Priorities', 'project-management') . '</option>';
